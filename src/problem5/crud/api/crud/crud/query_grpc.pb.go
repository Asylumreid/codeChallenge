...
const (
	...
	Query_ShowPost_FullMethodName          = "/crud.crud.Query/ShowPost"
	Query_ListPost_FullMethodName          = "/crud.crud.Query/ListPost"
	Query_ListSpecificPosts_FullMethodName = "/crud.crud.Query/ListSpecificPosts"
)
...
func (c *queryClient) ListSpecificPosts(ctx context.Context, in *QueryListSpecificPostsRequest, opts ...grpc.CallOption) (*QueryListSpecificPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListSpecificPosts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ListSpecificPosts(context.Context, *QueryListSpecificPostsRequest) (*QueryListSpecificPostsResponse, error) {
...
func _Query_ListSpecificPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ListSpecificPosts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
